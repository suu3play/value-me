...
const BasicInputForm: React.FC<BasicInputFormProps> = React.memo(
    ({ data, onChange }) => {
        ...
        const calculateOvertimeHoursFromFixedPay = (): number => {
            ...
            // 基本時給の計算
            const monthlyBaseWorkingHours =
                actualDailyWorkingHours * monthlyAverageWorkingDays;
            const baseHourlyWage =
                monthlyBaseWorkingHours > 0
            ...
            const monthlyOvertimeHours =
                data.fixedOvertimePay / (baseHourlyWage * 1.25);
            ...
            switch (data.workingHoursType) {
                ...
                case 'weekly':
                    return (
                        (monthlyOvertimeHours / monthlyAverageWorkingDays) * 5
                    );
                default: // monthly
                                    ...
                                    <ValidatedInput
                                        ...
                                        validator={(value) => {
                                            ...
                                            if (value > maxHours)
                                                return {
                                                    isValid: false,
                                                    message: `${maxHours}時間以下を入力してください`,
                                                };
                                            return { isValid: true };
                                        }}
                                        type="float"
                                    ...
                                    >
                                        ...
                                        data.fixedOvertimePay > 0 ? (
                                            ...
                                            >
                                                {data.workingHoursType ===
                                                    'daily' &&
                                                    `1日あたり ${calculateOvertimeHoursFromFixedPay().toFixed(
                                                        1
                                                    )}時間`}
                                                {data.workingHoursType ===
                                                    'weekly' &&
                                                    `1週あたり ${calculateOvertimeHoursFromFixedPay().toFixed(
                                                        1
                                                    )}時間`}
                                                {data.workingHoursType ===
                                                    'monthly' &&
                                                    `1ヶ月あたり ${calculateOvertimeHoursFromFixedPay().toFixed(
                                                        1
                                                    )}時間`}
                                            </Typography>
                                        ) : (
